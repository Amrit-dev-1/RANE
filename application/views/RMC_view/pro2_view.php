...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-sm-12">
            <h4 class="update">3,705 Properties for Sale in<br> or near Maharashtra Last Updated</h4>
        </div>
        <div class="col-md-4 col-sm-12">
